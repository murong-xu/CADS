...
def generate_latex_table(metric_data_1_dict, metric_data_2_dict, output_path, system_order=None):
    ...
    latex_code = [
        ...
        "\\hline",
        f"\\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\parbox[c]{{2cm}}{{\\centering \\textbf{{Organ}}}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{OMASeg}} \\\\ \\textbf{{({metric_name_1})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{TotalSeg}} \\\\ \\textbf{{({metric_name_1})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{OMASeg}} \\\\ \\textbf{{({metric_name_2})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{TotalSeg}} \\\\ \\textbf{{({metric_name_2})}} \\end{{tabular}} \\\\",
        "\\hline",
        "\\endfirsthead",
        "\\hline",
        f"\\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\parbox[c]{{2cm}}{{\\centering \\textbf{{Organ}}}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{OMASeg}} \\\\ \\textbf{{({metric_name_1})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{TotalSeg}} \\\\ \\textbf{{({metric_name_1})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{OMASeg}} \\\\ \\textbf{{({metric_name_2})}} \\end{{tabular}} & \\begin{{tabular}}[m]{{@{{}}c@{{}}}} \\textbf{{TotalSeg}} \\\\ \\textbf{{({metric_name_2})}} \\end{{tabular}} \\\\",
