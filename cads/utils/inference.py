...
def cleanup_nnunet_sidecar_json(output_dirs):
    """
    Remove nnUNet metadata sidecar JSON files that are not needed for CADS outputs.
    These files can be generated by nnUNet batch prediction/export.
    """
