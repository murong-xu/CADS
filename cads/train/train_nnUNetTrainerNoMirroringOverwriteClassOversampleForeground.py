...
def main():
    sys.argv = ['/data/muxu/20k/OMASeg/train/train_nnUNetTrainerNoMirroringOverwriteClassOversampleForeground.py',
                '552', 
                '3d_fullres', 
                'all',
                '-tr', 'nnUNetTrainerNoMirroringOverwriteClassOversampleForeground',
