...
def main():
    sys.argv = ['/data/muxu/20k/OMASeg/train/train_nnUNetTrainerNoMirroringOversampleImage_552_4000epochs.py',
                '552', 
                '3d_fullres', 
                'all',
                '-tr', 'nnUNetTrainerNoMirroringOversampleImage_4000epochs',
